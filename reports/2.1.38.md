...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${ZP.join(", ")} (default: user)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${ZP.join(", ")} (default: user)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${h91.join(", ")} (default: user)
