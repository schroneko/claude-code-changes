...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${UP.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${UP.join(", ")} (default: auto-detect)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${$z6.join(", ")} (default: user)
