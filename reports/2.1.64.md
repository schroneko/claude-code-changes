...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${jW.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${jW.join(", ")} (default: auto-detect)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${Fw6.join(", ")} (default: user)
