...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${eP.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${eP.join(", ")} (default: auto-detect)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${xz6.join(", ")} (default: user)
