...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${vP.join(", ")} (default: user)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${vP.join(", ")} (default: user)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${c91.join(", ")} (default: user)
