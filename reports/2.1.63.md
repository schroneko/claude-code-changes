...
### CLI Options
- ADDED: `claude plugin marketplace add <source> --scope <scope>` (Where to declare the marketplace: user (default), project, or local)
- ADDED: `claude plugin marketplace add <source> --sparse <paths...>` (Limit checkout to specific directories via git sparse-checkout (for monorepos). Example: --sparse .claude-plugin plugins)
- ADDED: `claude --scope <scope>` (Where to declare the marketplace: user (default), project, or local)
- ADDED: `claude --sparse <paths...>` (Limit checkout to specific directories via git sparse-checkout (for monorepos). Example: --sparse .claude-plugin plugins)
...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${wW.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${wW.join(", ")} (default: auto-detect)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${j26.join(", ")} (default: user)
