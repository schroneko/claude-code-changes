...
### CLI Commands
- ADDED: `claude remote-control` (hidden; aliases: claude rc; Connect your local environment for remote-control sessions via claude.ai/code)

### CLI Options
- ADDED: `claude remote-control -h, --help` (Display help for command)
...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${QP.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${QP.join(", ")} (default: auto-detect)
