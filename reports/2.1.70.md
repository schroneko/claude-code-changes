...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${BW.join(", ")} (default: auto-detect)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${BW.join(", ")} (default: auto-detect)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${l26.join(", ")} (default: user)
...
### Changes
- REMOVED: `claude open <cc-url>` (Connect to a Claude Code server (internal — use cc:// URLs))
- REMOVED: `claude server` (Start a Claude Code session server)
