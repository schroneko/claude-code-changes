...
- claude plugin disable [plugin] -s, --scope <scope> - Installation scope: ${tM.join(", ")} (default: user)
...
- claude plugin enable <plugin> -s, --scope <scope> - Installation scope: ${tM.join(", ")} (default: user)
...
- claude plugin update <plugin> -s, --scope <scope> - Installation scope: ${t51.join(", ")} (default: user)
